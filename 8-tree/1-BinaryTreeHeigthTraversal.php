...
class BinaryTree {
    ...
    public function dfsPreOrder($node)
    {
        ...
        $leftHeigth     = $this->dfsPreOrder($node->left);
        $rightHeigth    = $this->dfsPreOrder($node->right);
        
        $maxSubTreeHeigth      = max($leftHeigth, $rightHeigth);
        $diameterSubTree       = $leftHeigth + $rightHeigth;
        $nodeHeigth            = 1 + $maxSubTreeHeigth;

        echo "node: "       . $node->val . "\n";

        echo "leftHeigth: "     . $leftHeigth   . "\n";
        echo "rightHeigth: "    . $rightHeigth  . "\n";
        echo "maxSubTreeHeigth: " . $maxSubTreeHeigth . "\n";
        echo "diameterSubTree: " . $diameterSubTree . "\n";
        echo "nodeHeigth: "  . $nodeHeigth . "\n";
