...
class AllNodesDistanceK {
    ...
    function dfs($node, $downwardHeigth, $upwardHeigth)
    {
        ...
        if($downwardHeigth === $this->k) {
            echo "k: " . $this->k . "\n";
            echo "targetHeigth 53: " . $downwardHeigth . "\n";
            echo "node 53:  " . $node->val .  "\n";
            $this->ans[] = $node->val;
        }
        ...
        if($node->val === $this->target) {
            ...
            $downwardHeigth = 1;
            echo "node:  " . $node->val .  "\n";
            echo "targetHeigth 42: " . $downwardHeigth . "\n";
        }

        if($node->val !== $this->target && $downwardHeigth) {
            echo "node:  " . $node->val .  "\n";
            echo "targetHeigth 45: " . $downwardHeigth . "\n";
            $downwardHeigth++;
        }
        ...
        echo "node:  " . $node->val .  "\n";
        echo "leftUpwardHeigth: $leftUpwardHeigth "     . " of node_left: "     . $node->left?->val     . "\n";
        echo "rightUpwardHeigth: $rightUpwardHeigth "         . " of node_right: "    . $node->right?->val    . "\n";
    ...
    function findDescendant($node, $downwardHeigth) {
        ...
        // echo "node:  " . $node->val .  "\n";
        // echo "downwardHeigth: " . $downwardHeigth . "\n";

        if($downwardHeigth === $this->kComplement) {
            // echo "kComplement: " . $this->kComplement . "\n";
            // echo "downwardHeigth: " . $downwardHeigth . "\n";
            // echo "node 134:  " . $node->val .  "\n";
            $this->ans[] = $node->val;
        }
